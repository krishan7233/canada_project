      ...
      ?>
        <div class="quote-right">
          <div class="quote-box">
            ...
            <div class="btn-section"> <a target="_blank" href="{{url('single-plan',$ratePackage['id'])}}" class="buy-now">BUY NOW </a> 
            ...
            <button class="btn btn-primary compareData" id="compare_btn_{{$ratePackage['id']}}" style="display:none;">COMPARE</button>
              <div class="compaire">
                ...
                <div class="right"> <a target="_blank" href="{{url('single-plan',$ratePackage['id'])}}">Benefit Summary</a> </div>
              </div>
            </div>
          </div>
