      ...
      <div class="quote-right">
          <div class="quote-box">
            ...
            <a href="#" class="plan-details toggle togglePlanDetails" id="toggle" onclick="">PLAN DETAILS</a>
              <div class="compaire">
                <div class="left">
                  <input type="checkbox" class="form-check-input visitor_visa_couple_compare" id="visitor_visa_couple_compare" value="">
                  <label class="form-check-label" for="visitor_visa_couple_compare">Compare</label>
                  <button class="btn btn-primary visitor_visa_couple_compare_data" id="visitor_visa_couple_compare_btn_" style="display:none;">COMPARE</button>
