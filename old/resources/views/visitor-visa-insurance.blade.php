    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <form class="form-1" action="{{url('visitor-visa-single-quotation')}}" method="get">
              <!-- @csrf -->
            ...
            <div class="field-dob">
                ...
                <div class="field-tage">
                  <span>Age</span>
                  <input type="number" class="form-control ageInput" id="ageInput" name="age" value="<?php if(isset($_REQUEST['age'])){ echo $_REQUEST['age'];} else{ echo "35";} ?>">
                  <label>years</label>
            ...
            <div class="edate">
                ...
                <div class="field-tdays">
                	<span>Days</span>
                	<input type="number" class="form-control visitor-couple-single-day" value="<?php if(isset($_REQUEST['no_of_days'])){ echo $_REQUEST['no_of_days'];}else{ echo"90";}  ?>" name="no_of_days">
                    <label></label>
                </div>
            </div>
          ...
          <form class="form-1" action="{{url('visitor-couple-coverage-quotation')}}" method="get">
            <!-- @csrf -->
            ...
            <div class="number">1</div>
                ...
                <div class="field-tage">
                	...
                	<input type="number" class="form-control visitor-couple-policy-year1" name="visitor_visa_couple_age1" value="<?php if(isset($_REQUEST['visitor_visa_couple_age1'])){ echo $_REQUEST['visitor_visa_couple_age1'];} else{ echo"35";} ?>">
                    <label>years</label>
            ...
            <div class="number2">2</div>
                ...
                <div class="field-tage">
                	...
                	<input type="number" class="form-control visitor-couple-policy-year2" name="visitor_visa_couple_age2" value="<?php if(isset($_REQUEST['visitor_visa_couple_age2'])){ echo $_REQUEST['visitor_visa_couple_age2'];}else{ echo"30";} ?>" oninput="couplePolicyValidateAge2()">
                    <label>years</label>
            ...
            <div class="edate">
                ...
                <div class="field-tdays">
                	<span>Days</span>
                	<input type="number" class="form-control visitor-couple-days1" name="visitor_visa_couple_days1" value="<?php if(isset($_REQUEST['visitor_visa_couple_days1'])){ echo $_REQUEST['visitor_visa_couple_days1'];} else{ echo "90";} ?>">
                    <label></label>
                </div>
            </div>
           	...
           	<div class="seconddate">
                ...
                <div class="field-tdays">
                	...
                	<input type="number" class="form-control visitor-couple-days2" name="visitor_visa_couple_days2" value="<?php if(isset($_REQUEST['visitor_visa_couple_days2'])){ echo $_REQUEST['visitor_visa_couple_days2'];} else{ echo "90";} ?>">
                    <label>Days</label>
                </div>
            </div>
            </div>
          ...
          <form class="form-1" action="{{url('visitor-family-coverage-quotation')}}" method="get">
            ...
            <div class="number">1</div>
                ...
                <div class="field-tage">
                	...
                	<input type="number" class="form-control visitor-family-policy-year1" name="visitor_family_policy_year1" value="<?php if(isset($_REQUEST['visitor_family_policy_year1'])){ echo $_REQUEST['visitor_family_policy_year1'];} else{ echo"35";} ?>">
                    <label>years</label>
            ...
            <div class="number2">2</div>
                ...
                <div class="field-tage">
                	...
                	<input type="number" class="form-control visitor-family-policy-year2" name="visitor_family_policy_year2" value="<?php if(isset($_REQUEST['visitor_family_policy_year2'])){ echo $_REQUEST['visitor_family_policy_year2'];} else{ echo"30";} ?>">
                    <label>years</label>
            ...
            <div class="edate">
                ...
                <div class="field-tdays">
                	<span>Days</span>
                	<input type="number" class="form-control visitor-family-days" name="visitor_family_days" value="<?php if(isset($_REQUEST['visitor_family_days'])){ echo $_REQUEST['visitor_family_days'];} else{ echo"90";} ?>">
                    <label></label>
                </div>
            </div>
