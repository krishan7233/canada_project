...
Route::get('visitor-single-compare', [VisitorVisaController::class, 'visitorSingleCompare'])->name('visitor-single-compare');
Route::get('visitor-single-plan', [VisitorVisaController::class, 'visitorSingleBuyer'])->name('visitor-single-plan');
Route::get('visitor-visa-couple-compare-quote', [VisitorVisaController::class, 'compareCouple'])->name('visitor-visa-couple-compare-quote');
Route::get('visitor-visa-couple-plan-buyer', [VisitorVisaController::class, 'visitorVisaCouplePlanBuyer'])->name('visitor-visa-couple-plan-buyer');
Route::get('visitor-family-compare', [VisitorVisaController::class, 'visitorFamilyCompare'])->name('visitor-family-compare');
Route::get('visitor-family-plan-buyer', [VisitorVisaController::class, 'visitorFamilyBuyer'])->name('visitor-family-plan-buyer');
...
Route::get('super-visa-couple-compare-quote', [AuthController::class, 'superVisaCompareQuote'])->name('super-visa-couple-compare-quote');
Route::get('super-visa-couple-plan-buyer', [AuthController::class, 'superVisaCouplePlanBuyer'])->name('super-visa-couple-plan-buyer');
...
Route::get('single-plan', [AuthController::class, 'singlePlan'])->name('single-plan');
