  ...
  <div class="container mt-60">
    <div class="row">
      ...
      ?>
          ...
          <div id="text{{$ratePackage['id']}}" style="display:none;" class="hidden-plan-details">
            <div class="row">
              <div class="col-lg-4">
                <div class="section1">
                  <h4>Summary</h4>
                  <p>Coverage: {{request('coverage_amt')}}</p>
                  <p> Deductible: {{request('deductible')}}</p>
                  <p>Period: {{request('no_of_days')}} days</p>
                  <p> Pre-existing medical conditions: <b>{{request('pre_exit')}}</b> covered</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="section2">
              ...
              <div class="col-lg-4">
                <div class="section3"> <a href="tel:6475709070" class="call-btn"><i class="fa fa-mobile"></i> (647) 570-9070</a> <a href="{{url('visitor-single-plan',$ratePackage['id'])}}" class="benifit-sumry" target="_blank">Benefit Summary</a> <a href="{{url('visitor-single-plan',$ratePackage['id'])}}" target="_blank" class="srt-app">Start Application</a> </div>
              </div>
            </div>
          </div>
              <!-- detail data -->
        ...
        <script>
          function togglePlanDetails{{$ratePackage['id']}}() {
            // alert("hello");
            $('<?php echo '#text'.$ratePackage['id']; ?>').toggle();  // Assuming 'package' contains the desired ID
          }
        </script>
      @endforeach
      </div>
