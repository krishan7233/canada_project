...
$compare_data = companyDetail($buyer_data['c_id']);
$annually_amount = valueNumberFormate($buyer_data['final_result']);
...
<div class="plan-details-page">
    <div class="container">
        <div class="row">
            ...
            <img src="{{companyPhoto($buyer_data['c_id'])}}" />
            ...
            <?php 
            if(perMonthCheck($buyer_data['c_id'])==1){
            ?> 
            <h3><span><strong>{{number_format(($buyer_data['final_result']/12),2)}}</strong>/month</span></h3>
            <?php } ?>
