        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <form class="form-1 formsubmit1" action="{{url('find-quotation')}}" method="get">
            ...
            <div class="field-dob">
                ...
                <div class="field-tage">
                  <span>Age</span>
                  <input type="number" class="form-control ageInput" id="ageInput" name="age" placeholder="60" value="<?php if(isset($_REQUEST['age'])){ echo $_REQUEST['age'];} else{ echo"60";}  ?>">
                  <label>years</label>
          ...
          <form class="form-1 formsubmit2" action="{{url('super-visa-post')}}" method="get">
            ...
            <div class="form-field-row">
            	<div class="coverage">
                	 <span>Coverage</span>
                    <select class="form-control super_visa_couple_coverage1" name="super_visa_couple_coverage1">
...
<div class="Visa-descrption">
	<div class="container">
    	<div class="row">
            ...
            <div class="col-lg-6">
            	<img src="assets/images/super-visa-ins.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</div>
...
<script>
  ...
  $(document).on('click', '.otheramt-toggle', function() {
    ...
    if ($(this).text() == "+ Enter different coverage amount per applicant") {
        ...
        $('[name="super_visa_couple_coverage1"]').removeClass('super_visa_couple_coverage1');
        $(this).text("− Make coverage amount same for all applicants");
    } else {
        $('.amt_type').val(0);
        $('.coverage-check').val('');
        $('[name="super_visa_couple_coverage1"]').addClass('super_visa_couple_coverage1');
        $(this).text("+ Enter different coverage amount per applicant");
    }
});

$(document).on('change', '.super_visa_couple_coverage1', function() {
    ...
    $('.otheramt').html('<div class="form-field-row"> <div class="coverage"> <span>Coverage</span> <select class="form-control" name="super_visa_couple_coverage2">'+options+' </select> </div> </div>');
});
</script>
