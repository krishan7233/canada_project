...
<div class="plan-details-page">
      <?php 
      $amount1 = valueNumberFormate($couple_plan['final_result1']);
      $amount2 = valueNumberFormate($couple_plan['final_result2']);
      ?>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
              ...
              <?php 
            if((perMonthCheck($couple_plan['c_id'])==1) && (request('visa_type')!="visitorCouple")){
            ?> 
