      ...
      <div class="quote-right">
          <div class="quote-box">
            <div class="logo-section"> <img src="{{companyPhoto($package['c_id'])}}" /> </div>
              ...
              $annually_amount = valueNumberFormate($sumPackage);
              ?>
              <!-- <p>Total : <strong>$ {{number_format($sumPackage,2)}}</strong></p> -->
              <?php  if(perMonthCheck($package['c_id'])==1){
                if($package['c_id']==10){
                  $perMonth = valueNumberFormate(($sumPackage/12)+10);
                }
                else{
                  $perMonth = valueNumberFormate(($sumPackage/12));
                }
              ?>
              ...
              <div class="logo_img">
                <span> <img src="{{asset('assets/user.png')}}" class="user1_img" alt=""> ${{number_format($package['final_result1'],2)}}</span>
                <span > <img src="{{asset('assets/group.png')}}" class="user2_img" alt="">${{number_format($package['final_result2'],2)}}</span>
              </div>
